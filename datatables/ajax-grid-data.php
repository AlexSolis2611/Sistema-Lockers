...
$sql = "SELECT id, no_colaborador, nombres, fecha_asignacion, puesto, sexo, no_locker, area_locker";
$sql.=" FROM empleados";
...
if( !empty($requestData['search']['value']) ) {
    ...
    $sql.=" OR no_locker LIKE '".$requestData['search']['value']."%' ";
