        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="#">Sistemas Control de lockers</a>
			...
			?>			
                    <div class="panel panel-default">
                        ...
                        <h3 class="panel-title"><i class="icon-user"></i> Datos de los colaboradores</h3> 
							...
							<hr>
                                    <table id="lookup" class="table table-bordered table-hover">  
	                                   <thead bgcolor="#eeeeee" align="center">
										...
										<th>Sexo</th>
										<th># Locker</th>
										<th>Area Locker</th>	     	<th class="text-center">Acciones</th>	
	                                     </tr>                                 
                                        </thead>
                                        <tbody>
                                        </tbody>
