    ...
    <body>
       <div class="navbar navbar-fixed-top">
			...
			if(isset($_POST['input'])){
				...
				$insert = mysqli_query($conn, "INSERT INTO empleados(id, nombres, fecha_asignacion, puesto, sexo, no_locker, area_locker)
					VALUES(NOT NULL,'$nombres', '$fecha_asignacion', '$puesto', '$sexo', '$no_locker', '$area_locker')") or die(mysqli_error());
						if($insert){
